...
public void testMatch_ExpiredExplicit() throws IOException {
  long testTTL=1000;
  MatchCode[] expected=new MatchCode[]{MatchCode.SKIP,MatchCode.INCLUDE,MatchCode.SKIP,MatchCode.INCLUDE,MatchCode.SKIP,MatchCode.NEXT};
  QueryMatcher qm=new QueryMatcher(get,fam2,get.getFamilyMap().get(fam2),testTTL,rowComparator,1);
