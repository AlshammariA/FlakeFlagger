@Test public void should_set_to_embedded_id_and_create_builder() throws Exception {
  ...
  SliceQueryBuilder<ClusteredEntity>.SliceToEmbeddedIdBuilder embeddedIdBuilder=builder.toEmbeddedId(embeddedKey);
