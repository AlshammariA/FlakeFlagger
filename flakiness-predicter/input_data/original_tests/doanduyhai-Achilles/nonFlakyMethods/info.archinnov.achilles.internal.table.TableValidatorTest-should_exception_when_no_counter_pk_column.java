@Test public void should_exception_when_no_counter_pk_column(){
  ...
  exception.expectMessage(String.format("Cannot find column '%s' from table '%s'",CQL_COUNTER_PRIMARY_KEY,CQL_COUNTER_TABLE));
