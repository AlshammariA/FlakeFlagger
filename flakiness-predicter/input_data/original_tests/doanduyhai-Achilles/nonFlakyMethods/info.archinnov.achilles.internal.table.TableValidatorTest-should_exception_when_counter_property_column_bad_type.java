@Test public void should_exception_when_counter_property_column_bad_type(){
  ...
  exception.expectMessage(String.format("Column '%s' of type '%s' should be of type '%s'",CQL_COUNTER_PROPERTY_NAME,propertyColumnMeta.getType(),text()));
