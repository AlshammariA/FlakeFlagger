@Test public void queryBetweenIncludeLower() throws Exception {
  ...
  Iterator<ValuePathTuple> filtered=Iterables.filter(nodes,new ValuePathTuple.BetweenPredicate(searchForStart,searchForEnd,true,false)).iterator();
