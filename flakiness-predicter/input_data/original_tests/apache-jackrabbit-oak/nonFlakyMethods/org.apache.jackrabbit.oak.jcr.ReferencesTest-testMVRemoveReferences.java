public void testMVRemoveReferences() throws RepositoryException {
  ...
  Value[] vs=new Value[]{superuser.getValueFactory().createValue(ref0),superuser.getValueFactory().createValue(ref1),superuser.getValueFactory().createValue(ref2)};
  ...
  vs=new Value[]{superuser.getValueFactory().createValue(ref1),superuser.getValueFactory().createValue(ref2)};
  n.setProperty("myref",vs);
  superuser.save();
