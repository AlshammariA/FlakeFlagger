@Test public void queryBetweenIncludeBoth() throws Exception {
  ...
  Iterator<ValuePathTuple> filtered=Iterables.filter(nodes,new ValuePathTuple.BetweenPredicate(searchForStart,searchForEnd,true,true)).iterator();
