@Test public void queryBetweenIncludeHigher() throws Exception {
  ...
  Iterator<ValuePathTuple> filtered=Iterables.filter(nodes,new ValuePathTuple.BetweenPredicate(searchForStart,searchForEnd,false,true)).iterator();
