/** 
 * test the iteration of the index with 2 shuffled items without the :start node <code> :index : { :start : { :next=n1 }, n0 : { :next= }, n1 : { :next=n0 } } </code>
 */
@SuppressWarnings("unchecked") @Test public void childNodeEntriesACoupleOfMixedItemsNoStart(){
