/** 
 * @since OAK 1.0 : password property is not longer mandatory -> multivaluedproperty will just be ignored (instead of throwing ConstraintViolationException upon save).
 */
